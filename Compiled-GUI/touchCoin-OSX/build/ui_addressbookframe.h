...
public:
    ...
    void retranslateUi(QFrame *AddressBookFrame)
    {
        ...
        m_addAddressButton->setText(QApplication::translate("AddressBookFrame", "New address", Q_NULLPTR));
        m_deleteAddressButton->setText(QApplication::translate("AddressBookFrame", "Delete address", Q_NULLPTR));
