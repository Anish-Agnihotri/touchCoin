...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WalletGui__NewAddressDialog_t, stringdata) + ofs \
...
const QMetaObject WalletGui::NewAddressDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_WalletGui__NewAddressDialog.data,
      qt_meta_data_WalletGui__NewAddressDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WalletGui__NewAddressDialog.stringdata))
