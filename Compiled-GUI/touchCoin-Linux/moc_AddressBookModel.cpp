...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WalletGui__AddressBookModel_t, stringdata) + ofs \
...
const QMetaObject WalletGui::AddressBookModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_WalletGui__AddressBookModel.data,
      qt_meta_data_WalletGui__AddressBookModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WalletGui__AddressBookModel.stringdata))
