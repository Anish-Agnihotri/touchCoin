...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WalletGui__TransferFrame_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 45, 12)
    ...
    "WalletGui::TransferFrame\0addressBookClicked\0"
    "\0pasteClicked\0"
};
...
const QMetaObject WalletGui::TransferFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_WalletGui__TransferFrame.data,
      qt_meta_data_WalletGui__TransferFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WalletGui__TransferFrame.stringdata))
