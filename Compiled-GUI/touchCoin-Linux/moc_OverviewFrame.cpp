...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WalletGui__OverviewFrame_t, stringdata) + ofs \
...
const QMetaObject WalletGui::OverviewFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_WalletGui__OverviewFrame.data,
      qt_meta_data_WalletGui__OverviewFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WalletGui__OverviewFrame.stringdata))
