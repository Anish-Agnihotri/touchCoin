...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WalletGui__TransactionsFrame_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 65, 6)
    ...
    "\0showTransactionDetails\0_index\0"
};
...
const QMetaObject WalletGui::TransactionsFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_WalletGui__TransactionsFrame.data,
      qt_meta_data_WalletGui__TransactionsFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WalletGui__TransactionsFrame.stringdata))
