...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WalletGui__TransactionFrame_t, stringdata) + ofs \
...
const QMetaObject WalletGui::TransactionFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_WalletGui__TransactionFrame.data,
      qt_meta_data_WalletGui__TransactionFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WalletGui__TransactionFrame.stringdata))
